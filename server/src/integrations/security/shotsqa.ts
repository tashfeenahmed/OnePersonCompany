 ...
 *
 * Venture capture rejects browser error screens and blank images before
 * saving a preview. This broader audit also checks historical captures,
 * image freshness, and site failures discovered after a capture was taken.
 *
 ...
 *
 * THE PNG IS DECODED BY tools/png.ts, IN NODE, WITH NO DEPENDENCY. `zlib.inflateSync` plus
...
import { decodePng, type PixelStats } from "../../tools/png.ts";
export { decodePng, type PixelStats, type Decoded } from "../../tools/png.ts";
