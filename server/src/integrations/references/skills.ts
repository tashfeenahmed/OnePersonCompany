    ...
    actions: [
      {
        ...
        params: [
          ...
          },
          {
            ...
            type: "string",
            required: false,
            about: `The look and feel, forwarded VERBATIM to the image model and given to the writers as a line: "photographic, warm, hands at work". At most ${GUIDE_LIMITS.style} characters.`,
          },
          { name: "primary", type: "string", required: false, about: "The brand's primary colour as a six-digit hex, typed over the measured one. Empty string returns to the measurement." },
          { name: "secondary", type: "string", required: false, about: "The secondary colour, hex. Empty string returns to the measurement." },
          { name: "background", type: "string", required: false, about: "The background colour, hex. Empty string returns to the measurement." },
          { name: "ink", type: "string", required: false, about: "The text colour, hex. Empty string returns to the measurement." },
          { name: "logo", type: "string", required: false, about: "The id of a logo asset in the venture's library, which the Studio then hands the image model on every post. Empty string means no active logo." },
        ],
        destructive: true,
      },
    ],
