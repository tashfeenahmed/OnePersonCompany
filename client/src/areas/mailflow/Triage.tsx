    ...
    <div className="min-h-0 flex-1 overflow-y-auto px-6 pt-2 pb-16">
      <div className="mx-auto w-full max-w-[940px]">
        <div className="mt-2 mb-5 flex items-end gap-3">
          <div>
            <h1 className="mb-1 text-[25px] font-normal tracking-[-0.025em]">Triage</h1>
        ...
        {d && (
          <>
            ...
            <p className="text-muted-foreground mb-5 text-[11.5px]">
              {d.lastRun
                ? `Last scored ${new Date(d.lastRun.ranAt).toLocaleString()} — ${d.lastRun.note ?? ""}${d.lastRun.error ? ` · ${d.lastRun.error}` : ""}`
